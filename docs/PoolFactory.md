...
# Event `DAOAddressSet(address daoAddress)` {#PoolFactory-DAOAddressSet-address-}
No description

# Event `GovernanceAddressSet(address governanceAddress)` {#PoolFactory-GovernanceAddressSet-address-}
No description
...
# Event `SetPoolManagerFee(uint256 numerator, uint256 denominator)` {#PoolFactory-SetPoolManagerFee-uint256-uint256-}
No description

# Event `SetMaximumManagerFee(uint256 numerator, uint256 denominator)` {#PoolFactory-SetMaximumManagerFee-uint256-uint256-}
No description

# Event `SetMaximumManagerFeeNumeratorChange(uint256 amount)` {#PoolFactory-SetMaximumManagerFeeNumeratorChange-uint256-}
No description

# Event `SetAssetHandler(address assetHandler)` {#PoolFactory-SetAssetHandler-address-}
No description

# Event `SetPoolStorageVersion(uint256 poolStorageVersion)` {#PoolFactory-SetPoolStorageVersion-uint256-}
No description

# Event `SetManagerFeeNumeratorChangeDelay(uint256 delay)` {#PoolFactory-SetManagerFeeNumeratorChangeDelay-uint256-}
No description
