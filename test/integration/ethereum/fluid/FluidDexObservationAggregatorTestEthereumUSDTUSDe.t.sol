...
contract FluidDexObservationAggregatorTestEthereumUSDTUSDe is FluidDexObservationAggregatorTestSetup {
  ...
  constructor()
    FluidDexObservationAggregatorTestSetup(
      ...
      EthereumConfig.USDT,
      IAggregatorV3Interface(EthereumConfig.USDe_CHAINLINK_ORACLE),
      TWAP_PERIOD,
