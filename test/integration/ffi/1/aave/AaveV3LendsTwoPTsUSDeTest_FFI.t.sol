...
import {AaveV3LendsTwoPTsUSDeTest} from "test/integration/ethereum/aaveV3/AaveV3LendsTwoPTsUSDeTest.t.sol";
...
contract AaveV3LendsTwoPTsUSDeTestFFI is AaveV3TestFFI, AaveV3LendsTwoPTsUSDeTest {
  constructor() AaveV3TestFFI(EthereumConfig.CHAIN_ID) AaveV3LendsTwoPTsUSDeTest() {}

  function setUp() public override(AaveV3TestFFI, AaveV3LendsTwoPTsUSDeTest) {
    super.setUp();
  }
