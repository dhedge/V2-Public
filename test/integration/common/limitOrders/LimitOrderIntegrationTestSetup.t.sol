...
import {DHedgePoolAggregator} from "contracts/priceAggregators/DHedgePoolAggregator.sol";
...
abstract contract LimitOrderIntegrationTestSetup is BackboneSetup {
  ...
  function setUp() public virtual override {
    ...
    DHedgePoolAggregator torosPoolPriceAggregator = new DHedgePoolAggregator(address(testTorosPool));
    ...
    IAssetHandler.Asset memory torosPoolAsset = IAssetHandler.Asset({
      ...
      aggregator: address(torosPoolPriceAggregator)
    });
