...
const testCases: EasySwapperTestCase[] = [
  ...
  {
    testName: "ETHBEAR2X - can deposit and withdraw - no swap in, swap out to usdc",
  ...
  {
    testName: "ETHBEAR2X - can deposit and withdraw - no swap in, no swap out",
    dhedgePoolAddress: torosPools.ETHBEAR2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(20_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
  ...
  {
    testName: "BTCBEAR2X - can deposit and withdraw - no swap in, swap out to usdc",
  ...
  {
    testName: "BTCBEAR2X - can deposit and withdraw - no swap in, swap out to wbtc",
    dhedgePoolAddress: torosPools.BTCBEAR2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(20_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
  ...
  {
    testName: "BTCBEAR2X - can deposit and withdraw - no swap in, no swap out",
    dhedgePoolAddress: torosPools.BTCBEAR2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(20_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
