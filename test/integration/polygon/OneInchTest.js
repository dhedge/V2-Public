...
describe("OneInch V3 Test", function () {
  ...
  it("Should be able to approve", async () => {
    ...
    approveABI = iERC20.encodeFunctionData("approve", [oneInchV3Router, (200e6).toString()]);
  ...
  it("should be able to swap tokens on oneInch - unoswap.", async () => {
    ...
    const unoswapABI = iAggregationRouterV3.encodeFunctionData("unoswap", [
      srcAsset,
      srcAmount,
      0,
      // await getAmountOut(quickswapRouter, srcAmount, [usdc, usdt]),
      // 0x2cf7252e74036d1da831d11089d326296e64a728
      ["0x80000000000000003b6d0340" + quickLpUsdcUsdt.slice(2, quickLpUsdcUsdt.length)],
    ]);
