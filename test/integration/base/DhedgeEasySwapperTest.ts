...
const testCases: EasySwapperTestCase[] = [
  ...
  {
    testName: "Ethereum Yield",
    dhedgePoolAddress: baseChainData.torosPools.ETHy,
    userDepositToken: baseChainData.assets.weth,
    depositAmount: units(10),
    userDepositTokenSlot: baseChainData.assetsBalanceOfSlot.weth,
    poolDepositToken: baseChainData.assets.weth,
    withdrawToken: baseChainData.assets.weth,
    nativeAssetDepositAmount: units(10),
  },
  {
    testName: "Staked Ethereum Bull 2X",
    dhedgePoolAddress: baseChainData.torosPools.STETHBULL2X,
    userDepositToken: baseChainData.assets.weth,
    depositAmount: units(1, 17),
    userDepositTokenSlot: baseChainData.assetsBalanceOfSlot.weth,
    poolDepositToken: baseChainData.assets.reth,
    withdrawToken: baseChainData.assets.weth,
    nativeAssetDepositAmount: units(10),
  },
  {
    testName: "Staked Ethereum Bull 3X",
    dhedgePoolAddress: baseChainData.torosPools.STETHBULL3X,
    userDepositToken: baseChainData.assets.weth,
    depositAmount: units(1, 17),
    userDepositTokenSlot: baseChainData.assetsBalanceOfSlot.weth,
    poolDepositToken: baseChainData.assets.reth,
  ...
  {
    testName: "Staked Ethereum Bull 4X",
    dhedgePoolAddress: baseChainData.torosPools.STETHBULL4X,
    userDepositToken: baseChainData.assets.weth,
    depositAmount: units(1, 17),
    userDepositTokenSlot: baseChainData.assetsBalanceOfSlot.weth,
    poolDepositToken: baseChainData.assets.reth,
