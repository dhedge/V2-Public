...
describe("Bytecode Test", function () {
  ...
  it("PoolPerformance Should have matching byte code", async function () {
    const PoolPerformance = await ethers.getContractFactory("PoolPerformance");
    const creationBytecode = PoolPerformance.bytecode;
    const implementation = await getImplementationAddress(ethers.provider, poolPerformance.address);
    const runtimeBytecode = await ethers.provider.getCode(implementation);
  ...
  it("PoolPerformance Real Should have matching byte code", async function () {
    const PoolPerformance = await ethers.getContractFactory("PoolPerformance");
    const creationBytecode = PoolPerformance.bytecode;
