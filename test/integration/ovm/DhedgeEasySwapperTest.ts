...
const testCases: EasySwapperTestCase[] = [
  ...
  {
    testName: "USDpy",
    dhedgePoolAddress: torosPools.USDpy,
    userDepositToken: assets.usdcNative,
    depositAmount: units(20_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
    poolDepositToken: assets.susd,
    withdrawToken: assets.usdcNative,
    nativeAssetDepositAmount: units(10),
  },
  {
    testName: "USDmny",
    dhedgePoolAddress: torosPools.USDMNY,
    userDepositToken: assets.usdcNative,
    depositAmount: units(20_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
    poolDepositToken: assets.usdcNative,
  ...
  {
    testName: "ETHy",
    dhedgePoolAddress: torosPools.ETHY,
    userDepositToken: assets.weth,
    depositAmount: units(8),
    userDepositTokenSlot: assetsBalanceOfSlot.weth,
    poolDepositToken: assets.wstETH,
    withdrawToken: assets.weth,
    nativeAssetDepositAmount: units(10),
  },
  /* BULL */
  {
    testName: "BTCBULL4X - can deposit and withdraw - swap in, no swap out",
    dhedgePoolAddress: torosPools.BTCBULL4X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(1_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
    poolDepositToken: assets.susd,
    withdrawToken: assets.susd,
    nativeAssetDepositAmount: units(10),
  ...
  {
    testName: "BTCBULL4X - can deposit and withdraw - swap in, swap out",
    dhedgePoolAddress: torosPools.BTCBULL4X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(1_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
  ...
  {
    testName: "BTCBULL3X - can deposit and withdraw - swap in, no swap out",
  ...
  {
    testName: "BTCBULL2X - can deposit and withdraw - swap in, no swap out",
  ...
  {
    testName: "BTCBULL2X - can deposit and withdraw - swap in, swap out",
    dhedgePoolAddress: torosPools.BTCBULL2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(1_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
  ...
  {
    testName: "SOLBULL3X - can deposit and withdraw - swap in, no swap out",
    dhedgePoolAddress: torosPools.SOLBULL3X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(1_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
    poolDepositToken: assets.susd,
  ...
  {
    testName: "SOLBULL3X - can deposit and withdraw - swap in, swap out",
    dhedgePoolAddress: torosPools.SOLBULL3X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(1_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
  ...
  {
    testName: "SOLBULL2X - can deposit and withdraw - swap in, no swap out",
    dhedgePoolAddress: torosPools.SOLBULL2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(5_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
    poolDepositToken: assets.susd,
    withdrawToken: assets.susd,
    nativeAssetDepositAmount: units(10),
  ...
  {
    testName: "SOLBULL2X - can deposit and withdraw - swap in, swap out",
    dhedgePoolAddress: torosPools.SOLBULL2X,
    userDepositToken: assets.usdcNative,
    depositAmount: units(5_000, 6),
    userDepositTokenSlot: assetsBalanceOfSlot.usdcNative,
