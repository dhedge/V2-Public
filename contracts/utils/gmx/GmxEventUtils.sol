...
library GmxEventUtils {
  ...
  function getArray(AddressItems memory addresses, string memory key) external pure returns (address[] memory) {
  ...
  function getArrayWithoutRevert(
    ...
    string memory key
  ) public pure returns (bool, address[] memory) {
    for (uint256 i = 0; i < addresses.arrayItems.length; i++) {
  ...
  function getWithoutRevert(UintItems memory items, string memory key) public pure returns (bool, uint256) {
    for (uint256 i = 0; i < items.items.length; i++) {
  ...
  function getArray(UintItems memory items, string memory key) external pure returns (uint256[] memory) {
  ...
  function getArrayWithoutRevert(
    ...
    string memory key
  ) public pure returns (bool, uint256[] memory) {
    for (uint256 i = 0; i < items.arrayItems.length; i++) {
  ...
  function getArray(IntItems memory items, string memory key) external pure returns (int256[] memory) {
  ...
  function getArrayWithoutRevert(IntItems memory items, string memory key) public pure returns (bool, int256[] memory) {
    for (uint256 i = 0; i < items.arrayItems.length; i++) {
      if (compareStrings(items.arrayItems[i].key, key)) {
        return (true, items.arrayItems[i].value);
      }
  ...
  function getArray(BoolItems memory items, string memory key) external pure returns (bool[] memory) {
  ...
  function getArrayWithoutRevert(BoolItems memory items, string memory key) public pure returns (bool, bool[] memory) {
    for (uint256 i = 0; i < items.arrayItems.length; i++) {
      if (compareStrings(items.arrayItems[i].key, key)) {
        return (true, items.arrayItems[i].value);
      }
  ...
  function getArray(Bytes32Items memory items, string memory key) external pure returns (bytes32[] memory) {
  ...
  function getArrayWithoutRevert(
    ...
    string memory key
  ) public pure returns (bool, bytes32[] memory) {
    for (uint256 i = 0; i < items.arrayItems.length; i++) {
      if (compareStrings(items.arrayItems[i].key, key)) {
        return (true, items.arrayItems[i].value);
      }
  ...
  function getArray(BytesItems memory items, string memory key) external pure returns (bytes[] memory) {
  ...
  function getArray(StringItems memory items, string memory key) external pure returns (string[] memory) {
