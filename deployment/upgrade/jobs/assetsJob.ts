...
export enum AssetType {
  ...
  "Pancake CL NFT Position Asset" = 31,
  "Flat Money Options NFT Position Asset" = 32,
  "Flat Money Collateral Lending Enabled" = 33,
  "Fluid Token" = 34,
  "Flat Money V2 UNIT" = 35,
  "Flat Money V2 Perp NFT Position Asset" = 36,
  "Pendle Principal Token" = 37,
  "Virtual Token Asset" = 38,
  "Hyperliquid Perps Account" = 39,
  "Hyperliquid ERC20 Spot Linked Asset" = 40,
  ...
  "Gmx Perps Market Asset" = 105,
  "Dytm Office Asset" = 106,
  "Reward Asset" = 200,
