...
interface IHasAssetInfoV24Interface extends ethers.utils.Interface {
  functions: {
...
export class IHasAssetInfoV24 extends BaseContract {
  ...
  interface: IHasAssetInfoV24Interface;
