...
interface PoolFactoryInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setPoolPerformanceAddress",
    values: [string]
  ): string;
  encodeFunctionData(
...
export type PoolPerformanceAddressSetEvent = TypedEvent<
  [string] & { poolPerformanceAddress: string }
>;
...
export class PoolFactory extends BaseContract {
  ...
  functions: {
    ...
    setPoolPerformanceAddress(
      _poolPerformanceAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "PoolPerformanceAddressSet(address)"(
      poolPerformanceAddress?: null
    ): TypedEventFilter<[string], { poolPerformanceAddress: string }>;
